...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp apps/firebase-app` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run apps/firebase-app:deploy` - Deploy this app to firebase
* `nx run apps/firebase-app:serve` - Serve this app using the firebase emulator
* `nx run apps/firebase-app:build` - Build all functions associated with this app
* `nx run apps/firebase-app:test` - Test all functions associated with this app
* `nx run apps/firebase-app:lint` - Lint all functions associated with this app
