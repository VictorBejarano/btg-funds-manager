  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<SubscriptionsBloc, SubscriptionsState>(
      listener: (context, state) {
        ...
        } else if (state is UnsubscriptionFailure) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
        ...
        } else if (state is UnsubscriptionInProgress) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Procesando desuscripción...')),
          );
        }
      },
      child: BlocBuilder<SubscriptionsBloc, SubscriptionsState>(
        buildWhen: (previous, current) {
          // Solo reconstruir en cambios de carga de listado
          return current is SubscriptionsLoadInProgress ||
              current is SubscriptionsLoadSuccess ||
              current is SubscriptionsLoadFailure ||
              current is SubscriptionsInitial;
        },
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () => showSubscriptionDetailsModal(context, sub),
                    ),
                  );
                },
              ),
