...
* `firebase.apps/btg-manager-api.json` - Firebase CLI Configuration for this project
...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp apps/btg-manager-api` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run apps/btg-manager-api:deploy` - Deploy this app to firebase
* `nx run apps/btg-manager-api:serve` - Serve this app using the firebase emulator
* `nx run apps/btg-manager-api:build` - Build all functions associated with this app
* `nx run apps/btg-manager-api:test` - Test all functions associated with this app
* `nx run apps/btg-manager-api:lint` - Lint all functions associated with this app
